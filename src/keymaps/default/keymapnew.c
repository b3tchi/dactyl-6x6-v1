...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x6(
        ...
        KC_LSFT, CTL_Z ,KC_X   , KC_C  , KC_V  , KC_B  ,                                        KC_N   , KC_M  ,KC_COMM, KC_DOT,CTL_SLS,KC_RSFT,
                KC_QUOT,KC_LALT,KC_UP,KC_DOWN,                                                       KC_LALT  ,KC_RGUI,LT2_COL,KC_RCTL,
                                                       KC_LCTL,KC_LGUI,        KC_RGUI,KC_ESC,
                                                KC_SPACE,KC_TAB,KC_LCTL,       KC_RCTL,KC_ENTER,KC_BSPC,
                                                                KC_LALT ,      KC_RALT
    ),
    [_LOWER] = LAYOUT_6x6(
        ...
        _______,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_TILD,                                       KC_AMPR,KC_P1  ,KC_P2  ,KC_P3  ,KC_PSLS,_______,
                _______,_______,_______,_______,                                                       _______,KC_PDOT,KC_P0  ,KC_PEQL,
